...
namespace webApiipAweb.Migrations
{
    ...
    [Migration("20221013134804_deleteChapterAwardColumn")]
    partial class deleteChapterAwardColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webApiipAweb.Models.TaskWithOpenAnswsExecution", b =>
                {
                    ...
                    b.Property<int?>("idTaskWithOpenAnsws")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("idTaskWithOpenAnsws");
            ...
            modelBuilder.Entity("webApiipAweb.Models.TaskWithOpenAnswsExecution", b =>
                {
                    b.HasOne("webApiipAweb.Models.TaskWithOpenAnsw", "TaskWithOpenAnsws")
                        .WithMany()
                        .HasForeignKey("idTaskWithOpenAnsws");
